            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  AboutItem(
                    onPage: () => context.router.push(AboutInfoRoute(block: block!.zero)),
                  ...
                  AboutItem(
                      onPage: () => context.router.push(AboutInfoRoute(block: block!.one)),
                  ...
                  AboutItem(
                      onPage: () => context.router.push(AboutInfoRoute(block: block!.two)),
                  ...
                  AboutItem(
                      onPage: () => context.router.push(AboutInfoRoute(block: block!.thee)),
                  ...
                  AboutItem(
                      onPage: () => context.router.push(AboutInfoRoute(block: block!.four)),
                  ...
                  Center(
                    child: Box(
                      child: Assets.images.about.logo.svg(fit: BoxFit.cover),
                    ),
                  ),
                ],
              ),
