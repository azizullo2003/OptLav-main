...
class FavoriteBloc extends Bloc<FavoriteEvent, FavoriteState> {
  ...
  FavoriteBloc(this.repository, this.userRepository) : super(const FavoriteState.loading()) {
    on<FavoriteEvent>((event, emit) async {
      ...
      await event.when<Future<void>>(
        ...
        removeProductFromFavorite: (firmId, productId) async =>
            (await userRepository.removeProductFromFavorite(firmId, productId)).fold(
                  (l) => emit(FavoriteState.failure(l)),
